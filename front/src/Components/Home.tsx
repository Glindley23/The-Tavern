    ...
    return (
       ...
       // </div>
         ...
         <Card.ImgOverlay>
           ...
           <Card.Text>
             <h2 className='homeText'>Manage your tavern with ease!</h2> 
             <h3 className='homeText'>Whether you're an established business brewing and feeding the city, or a hub for all things adventuring, use this application to organize your tavern's inventory.</h3>
           </Card.Text>
         </Card.ImgOverlay>
       </Card>
    )
